...
export default class register extends React.Component {
    ...
    submit() {
        ...
        if(this.state.name!=null&&this.state.email!=null&&this.state.password!=null&&this.state.confirmpassword!=null){
                                ...
                                <div className="row justify-content-between align-items-center mb-n50">
                                    ...
                                    <div className="col-lg-5 col-md-8 col-12 mx-auto mb-50">
                                        ...
                                        <div className="form_input">
                                            <input name="signup_name" placeholder="Name" type="text" onChange={(e) => this.setState({ name: e.target.value })} />
                                        </div>
                                        <div className="form_input">
                                            <input name="signup_email" placeholder="Email" type="email" onChange={(e) => this.setState({ email: e.target.value })} />
                                        </div>
                                        <div className="form_input">
                                            <input name="signup_password" placeholder="Password" type="password" onChange={(e) => this.setState({ password: e.target.value })} />
                                        </div>
                                        <div className="form_input">
                                            <input name="signup_password" placeholder="Retype Password" type="password" onChange={(e) => this.setState({ confirmpassword: e.target.value })} />
                                        </div>
                                        <div className="form_input_btn text-center mb-40">
                                            <button type="submit" className="btn btn-link" onClick={this.submit}>Signup here <img width={20} height={20} src="assets/img/icon/arrrow-icon.webp" alt="" /></button>
                                        </div>
                                        <p className="text-center">Already have account,  <a href="/login">Login here</a></p>
                                    </div>
                                </div>
                            </div>
                        </section>
